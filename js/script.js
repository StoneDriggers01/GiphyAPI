...
const searchInput = document.querySelector("#search-input"); // NEW: input field

// Event listener with async/await
fetchButton.addEventListener("click", async function () {
  const searchTerm = searchInput.value.trim(); // Get user input
  ...
  // Build dynamic endpoint using string interpolation
